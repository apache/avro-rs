...
* wget -q https://dist.apache.org/repos/dist/dev/avro/avro-rs/0.23.0/apache-avro-rs-0.23.0-RC0.tgz
* tar xvf apache-avro-rs-0.23.0-RC0.tgz
* cargo fmt --check && cargo test
* (optional) Update your project Cargo.toml to use `apache_avro = { path = "/path/to/0.23.0/avro" } and test your application
...
2. Select `rel/release-0.23.0` as the release tag and `auto` as the previous one (or select one manually)
...
On behalf of the Apache Avro team I am happy to announce the release of Apache Avro Rust SDK version 0.23.0!
...
1. Copy the body of the Github release and paste it in a temporary file, e.g. `/tmp/v0.23.0`
