...
mod reader {
    ...
    impl<'r, R: AvroRead + Unpin> Block<'r, R> {
        ...
        /// its content.
        async fn read_header(&mut self) -> AvroResult<()> {
            let mut buf = [0u8; 4];
            self.reader
                .read_exact(&mut buf)
                .await
        ...
        async fn fill_buf(&mut self, n: usize) -> AvroResult<()> {
    ...
    impl<'a, R: AvroRead + Unpin> Reader<'a, R> {
        ...
        pub async fn new(reader: R) -> AvroResult<Reader<'a, R>> {
            let block = Block::new(reader, vec![]).await?;
            let reader = Reader {
                block,
                reader_schema: None,
                errored: false,
        ...
        ///
        /// **NOTE** The avro header is going to be read automatically upon creation of the `Reader`.
        pub async fn with_schema(schema: &'a Schema, reader: R) -> AvroResult<Reader<'a, R>> {
            let block = Block::new(reader, vec![schema]).await?;
        ...
        pub async fn with_schemata(
            ...
            let block = Block::new(reader, schemata).await?;
            let mut reader = Reader {
                block,
                reader_schema: Some(schema),
                errored: false,
        ...
        #[inline]
        async fn read_next(&mut self) -> AvroResult<Option<Value>> {
    ...
    pub async fn from_avro_datum_reader_schemata<R: AvroRead + Unpin>(
        ...
        let value = decode_internal(writer_schema, rs.get_names(), &None, reader).await?;
        match reader_schema {
            Some(schema) => {
    ...
    "#;
        ...
        const ENCODED: &[u8] = &[
            ...
            101u8, 109u8, 97u8, 222u8, 1u8, 123u8, 34u8, 116u8, 121u8, 112u8, 101u8, 34u8, 58u8,
            34u8, 114u8, 101u8, 99u8, 111u8, 114u8, 100u8, 34u8, 44u8, 34u8, 110u8, 97u8, 109u8,
            101u8, 34u8, 58u8, 34u8, 116u8, 101u8, 115u8, 116u8, 34u8, 44u8, 34u8, 102u8, 105u8,
            101u8, 108u8, 100u8, 115u8, 34u8, 58u8, 91u8, 123u8, 34u8, 110u8, 97u8, 109u8, 101u8,
            34u8, 58u8, 34u8, 97u8, 34u8, 44u8, 34u8, 116u8, 121u8, 112u8, 101u8, 34u8, 58u8, 34u8,
            108u8, 111u8, 110u8, 103u8, 34u8, 44u8, 34u8, 100u8, 101u8, 102u8, 97u8, 117u8, 108u8,
            116u8, 34u8, 58u8, 52u8, 50u8, 125u8, 44u8, 123u8, 34u8, 110u8, 97u8, 109u8, 101u8,
            34u8, 58u8, 34u8, 98u8, 34u8, 44u8, 34u8, 116u8, 121u8, 112u8, 101u8, 34u8, 58u8, 34u8,
            115u8, 116u8, 114u8, 105u8, 110u8, 103u8, 34u8, 125u8, 93u8, 125u8, 20u8, 97u8, 118u8,
            114u8, 111u8, 46u8, 99u8, 111u8, 100u8, 101u8, 99u8, 8u8, 110u8, 117u8, 108u8, 108u8,
            0u8, 94u8, 61u8, 54u8, 221u8, 190u8, 207u8, 108u8, 180u8, 158u8, 57u8, 114u8, 40u8,
            173u8, 199u8, 228u8, 239u8, 4u8, 20u8, 54u8, 6u8, 102u8, 111u8, 111u8, 84u8, 6u8, 98u8,
            97u8, 114u8, 94u8, 61u8, 54u8, 221u8, 190u8, 207u8, 108u8, 180u8, 158u8, 57u8, 114u8,
        ...
        #[tokio::test]
        async fn test_from_avro_datum_with_union_to_struct() -> TestResult {
    ...
    "#;
        ...
        #[tokio::test]
        async fn test_avro_3549_read_not_enabled_codec() {
            let snappy_compressed_avro = vec![
                79, 98, 106, 1, 4, 22, 97, 118, 114, 111, 46, 115, 99, 104, 101, 109, 97, 210, 1,
                123, 34, 102, 105, 101, 108, 100, 115, 34, 58, 91, 123, 34, 110, 97, 109, 101, 34,
                58, 34, 110, 117, 109, 34, 44, 34, 116, 121, 112, 101, 34, 58, 34, 115, 116, 114,
                105, 110, 103, 34, 125, 93, 44, 34, 110, 97, 109, 101, 34, 58, 34, 101, 118, 101,
                110, 116, 34, 44, 34, 110, 97, 109, 101, 115, 112, 97, 99, 101, 34, 58, 34, 101,
                120, 97, 109, 112, 108, 101, 110, 97, 109, 101, 115, 112, 97, 99, 101, 34, 44, 34,
                116, 121, 112, 101, 34, 58, 34, 114, 101, 99, 111, 114, 100, 34, 125, 20, 97, 118,
                114, 111, 46, 99, 111, 100, 101, 99, 12, 115, 110, 97, 112, 112, 121, 0, 213, 209,
                241, 208, 200, 110, 164, 47, 203, 25, 90, 235, 161, 167, 195, 177, 2, 20, 4, 12, 6,
                49, 50, 51, 115, 38, 58, 0, 213, 209, 241, 208, 200, 110, 164, 47, 203, 25, 90,
                235, 161, 167, 195, 177,
            ];
